...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5654)), "C:\\Users\\dmian\\OneDrive\\Escritorio\\FC Pola\\fc-pola\\app\\page.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props)),(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8031))).default(props))],
    apple: [],
    openGraph: [],
    twitter: [],
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7263)), "C:\\Users\\dmian\\OneDrive\\Escritorio\\FC Pola\\fc-pola\\app\\layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props)),(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8031))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["C:\\Users\\dmian\\OneDrive\\Escritorio\\FC Pola\\fc-pola\\app\\page.tsx"];
...
function Home() {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        ...
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
            className: "home-text",
            children: "Para poder ingresar necesitas una invitaci\xf3n"
        })
    });
}
...
var __webpack_exports__ = __webpack_require__.X(0, [919,663,758,311], () => (__webpack_exec__(2832)));
